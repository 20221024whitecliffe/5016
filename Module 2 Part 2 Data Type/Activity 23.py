...
# datatype of datetime, timedelta
...
"""input = 11 Dec 2022
output = In 2 weeks timde, the date will be  2022-12-25 00:00:00
"""
...
"""input = 20 Sep 1983, 18 Jul 1990
output = The age difference is  -2493 days, 0:00:00
"""
...
# Here the result is not quite right. I believe it's due to the not-even years. 
# but how can solve this issue?
"""input = 20 Sep 2022, 2
output = The date after 2 years is 2024-09-19 00:00:00
"""
...
# output here should be always a positive integer, so maybe another change type to positive integer
"""input = 20 Sep 1983, 18 Jul 1990
output = The difference between the two dates in years is -6
"""