...
number_1 = int(input("Please enter a integer number smaller than 10"))
number_2 = int(input("Please enter a integer number bigger than 10"))
counter = 10
number = 10

starting_number = (10 % number_1) + 10

while counter < number_2:
    print(starting_number, end=",")
    starting_number = starting_number + number_1
    counter += number_1
